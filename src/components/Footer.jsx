...
import logo from "../assets/image/car10.png";
import { FaFacebook, FaGithub, FaYoutube } from "react-icons/fa";

const Footer = () => {
  return (
    <footer className="px-4 divide-y w-full  bg-gray-100 border-t-3 border-amber-400  text-gray-800">
      ...
      <div className="py-6 text-sm text-center dark:text-gray-600">
        © 2025 FleetGo. All rights reserved.
      </div>
    </footer>
  );
};
