...
const TopCar = ({ topCar }) => {
  ...
  return (
    <div className="card bg-base-100  shadow-sm">
      <figure>
        <img className="w-full h-[280px]" src={topCar.photo} />
      </figure>
      <div className="card-body sm:text-xl  text-black   bg-amber-50">
        <div className="sm:h-10/12">
          ...
          <div className="text-start">
            <p>
              <span className="font-semibold">Brand</span> : {topCar.brand}{" "}
            </p>
            <p>
              {" "}
            ...
            <p>
              {" "}
              <span className="font-semibold">Added On</span> : {topCar.date}{" "}
            </p>
          </div>
        </div>
        ...
        <div className="card-actions justify-end">
          <button
            onClick={() => navigate(`/car-details/${topCar._id}`)}
