    ...
    <div className=" ">
      <div className=" py-5 mb-5">
        ...
        <form
          ...
          className="fieldset border-2 border-gray-50    text-black shadow-xl rounded-box   p-3      "
        >
          <div className="   grid grid-cols-1 md:grid-cols-2 gap-6">
            <fieldset className="fieldset text-black bg-amber-50 border-gray-50 rounded-box border p-4 hidden">
            ...
            <fieldset className="fieldset bg-amber-50 border-gray-50 rounded-box border p-4">
            ...
            <fieldset className="fieldset bg-amber-50 border-gray-50 rounded-box border  w-full p-5">
              ...
              <div className="  ">
                ...
                <div className="flex gap-2 pt-1 text-gray-500  ">
                  <input
                    type="radio"
                    name="availability"
                    defaultValue={car?.availability}
            ...
            <fieldset className="fieldset hidden bg-amber-50 border-gray-50 rounded-box border p-4">
          ...
          <fieldset className="fieldset bg-amber-50 border-gray-50 rounded-box my-2 border p-4">
